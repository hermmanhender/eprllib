...
setup(
  ...
  version = '1.4.6',      # Recuerda incrementar la versión con cada cambio
  ...
  download_url = 'https://github.com/hermmanhender/eprllib/dist/eprllib-1.4.6.tar.gz',    # Ahora hablamos de esto
