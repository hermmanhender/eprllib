...
setup(
  ...
  version = '1.0.8',      # Recuerda incrementar la versión con cada cambio
  ...
  download_url = 'https://github.com/hermmanhender/eprllib/dist/eprllib-1.0.8.tar.gz',    # Ahora hablamos de esto
