...
setup(
  ...
  version = '1.2.5',      # Recuerda incrementar la versión con cada cambio
  ...
  download_url = 'https://github.com/hermmanhender/eprllib/dist/eprllib-1.2.5.tar.gz',    # Ahora hablamos de esto
