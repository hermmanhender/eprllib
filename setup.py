...
setup(
  ...
  version = '1.0.5',      # Recuerda incrementar la versión con cada cambio
  ...
  download_url = 'https://github.com/hermmanhender/natural_ventilation_EP_RLlib/dist/eprllib-1.0.5.tar.gz',    # Ahora hablamos de esto
