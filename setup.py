...
setup(
  ...
  version = 'v1.3.3',      # Recuerda incrementar la versión con cada cambio
  ...
  download_url = 'https://github.com/hermmanhender/eprllib/dist/eprllib-1.3.2.tar.gz',    # Ahora hablamos de esto
