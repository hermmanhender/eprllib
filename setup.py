...
setup(
  ...
  version = '1.5.0',      # Recuerda incrementar la versión con cada cambio
  ...
  download_url = 'https://github.com/hermmanhender/eprllib/dist/eprllib-1.5.0.tar.gz',    # Ahora hablamos de esto
