...
from eprllib.Agents.Rewards.EnergyRewards import EnergyWithMeters, EnergyWithMetersEnded, HierarchicalEnergyWithMeters
from eprllib.Agents.Rewards.ASHRAE55SimpleModel import ASHRAE55SimpleModel, ASHRAE55SimpleModelEnded, HierarchicalASHRAE55SimpleModel
...
class EnergyAndASHRAE55SimpleModelEnded(BaseReward):
    def __init__(
        self,
        reward_fn_config: Dict[str,Any],
        ):
        ...
        """
        super().__init__(reward_fn_config)
        self.comfort_reward = ASHRAE55SimpleModelEnded({
            "thermal_zone": reward_fn_config['thermal_zone']
        })
