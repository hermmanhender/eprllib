...
from configurations.reward_function import EnergyAndASHRAE55SimpleModel
with open("C:/Users/grhen/Documents/GitHub2/SimpleCases/configurations/task1g_config.json", "r") as f:
    episode_config = json.load(f)
    
experiment_name = "SimpleCases"
name = "task_1g_ashrae55sm"
tuning = False
restore = False
checkpoint_path = "C:/Users/grhen/ray_results/SimpleCases/20250507115203_task_1g_ashrae55sm_PPO"
...
eprllib_config.episodes(
    episode_fn = task1g_cofiguration,
...
if not restore:
    ...
    algo.training(
        ...
        model = {
            # FC Hidden layers
            "fcnet_hiddens": [64,64],#tune.grid_search([[64,64],[128,128],[64,64,64]]) if tuning else [64,64],
            "fcnet_activation": "tanh",
            ...
            # "attention_use_n_prev_rewards": 6,
    ...
    algo.env_runners(
        ...
        #     "initial_epsilon": 1.,
        #     "final_epsilon": 0.01,
        #     "epsilon_timesteps": 1008 * 25000 * number_of_agents,
    ...
    algo.multi_agent(
        ...
        policy_mapping_fn = task1_policy_map_fn,
