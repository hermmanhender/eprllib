...
algo.training(
    ...
    train_batch_size = 288*7, # 144 timesteps per episode (one day), 64 episodes.
    minibatch_size = 288,
    num_epochs = 10,
    ...
    clip_param = 0.1, #tune.quniform(0.1, 0.3, 0.05),
    vf_clip_param = 0.1, #tune.quniform(0.1, 0.3, 0.05),
)
algo.env_runners(
...
tuner = tune.Tuner(
    ...
    run_config=air.RunConfig(
        ...
        stop = {"info/num_env_steps_trained": 3000000},
        log_to_file = True,
