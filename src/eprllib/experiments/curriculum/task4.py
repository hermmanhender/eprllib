...
name: str = "task4"
checkpoint_path: str = "C:/Users/grhen/ray_results/curriculum/task3/checkpoint_final"
...
algo.training(
    ...
    gamma = 0.8,
    lr = 5e-5,
    train_batch_size = 144*7*5, # 144 timesteps per episode (one day), 64 episodes.
    minibatch_size = 144,
    num_epochs = 30,
    ...
    clip_param = 0.1,#tune.quniform(0.1, 0.3, 0.05) if tuning else 0.25,#
    vf_clip_param = 0.1,#tune.quniform(0.1, 0.3, 0.05) if tuning else 0.3,#
)
algo.env_runners(
