...
from eprllib.Agents.Triggers.SetpointTriggers import DualSetpointTriggerDiscreteAndAvailabilityTrigger_v2
...
with open("src/eprllib/examples/example_thermostat_files/curriculum_task4.json", "r") as f:
...
algo.training(
    ...
    train_batch_size = 289*7, # 144 timesteps per episode (one day), 64 episodes.
    minibatch_size = 289,
    num_epochs = 10,
...
tuner = tune.Tuner(
    ...
    run_config=air.RunConfig(
        ...
        stop = {"info/num_env_steps_trained": 2000000},
        log_to_file = True,
